...
public class TestCustomerForm extends DriverSetup{
	...
	public Object[][] getExcelData() throws Exception {
		...
		//filePath = "C:\\Users\\701255\\workspace\\customer_registration.xlsx";
		excelFile = new FileInputStream(filePath);
        ExcelWBook = new XSSFWorkbook(excelFile);
	    ExcelWSheet = ExcelWBook.getSheet("customer_invalid");
	    arrayExcelData=new String[][]{ { ExcelWSheet.getRow(1).getCell(1).getStringCellValue(), ExcelWSheet.getRow(1).getCell(2).getStringCellValue() ,ExcelWSheet.getRow(1).getCell(3).getStringCellValue(),ExcelWSheet.getRow(1).getCell(4).getStringCellValue(),ExcelWSheet.getRow(1).getCell(5).getStringCellValue()}};
